        ...
        for current_gpu in gpus_to_try:
            ...
            variables = {
                "input": {
                    ...
                    "dockerArgs":        "bash -c \"apt-get update && apt-get install -y curl && curl -fsSL https://tailscale.com/install.sh | sh && mkdir -p /home/default/init.d && curl -sL 'https://raw.githubusercontent.com/titoman81/playstone-gaming-base/main/agent/vm_startup.sh?v='$(date +%s) > /home/default/playstone_startup.sh && chmod +x /home/default/playstone_startup.sh && chown default:default /home/default/playstone_startup.sh && echo '#!/bin/bash' > /home/default/init.d/playstone_launcher.sh && echo 'nohup /home/default/playstone_startup.sh > /home/default/playstone.log 2>&1 &' >> /home/default/init.d/playstone_launcher.sh && chmod +x /home/default/init.d/playstone_launcher.sh && chown -R default:default /home/default/init.d && exec /entrypoint.sh\"",
